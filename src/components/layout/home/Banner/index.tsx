    ...
    return (
        <section className="container max-w-[1000px] mx-auto pt-36 px-4 md:px-0">
            <div className="flex flex-wrap items-center justify-between">
                <article className="w-full text-center justify-center md:text-left md:w-2/4 flex flex-col gap-5">
                    <h2 className="text-5xl font-bold">{banner.titulo}</h2>
                    <p className="text-lg">{banner.texto}</p>
                    <Link className="w-48 text-center rounded-3xl border border-solid border-white px-4 py-2 hover:bg-[#A79A86] hover:border-[#A79A86] transition" href="#contato">Entre em contato</Link>
                </article>
