...
export default function Footer() {
    return (
        <footer>
            <Container>
                <div className="flex flex-col md:grid md:grid-cols-3 gap-8 pb-8 pt-16">
                    <figure className="flex flex-col items-center md:items-start gap-5">
                        <Image
                            width={180}
                            height={47}
                            alt=""
                    ...
                    <div className="flex flex-col items-center md:items-start gap-3">
                        <h2 className="font-bold text-2xl text-center md:text-left">Horário de atendimento</h2>
                        <ul>
                ...
                <div className="flex flex-col md:flex-row text-center md:text-left justify-between py-5 w-full">
